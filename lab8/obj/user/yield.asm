...
0000000000800036 <__warn>:
  ...
  800048:	6d450513          	addi	a0,a0,1748 # 800718 <main+0x8e>
  ...
  800068:	70c50513          	addi	a0,a0,1804 # 800770 <main+0xe6>
...
0000000000800168 <exit>:
  ...
  800174:	5c850513          	addi	a0,a0,1480 # 800738 <main+0xae>
...
00000000008001ca <umain>:
  ...
  8001da:	57a58593          	addi	a1,a1,1402 # 800750 <main+0xc6>
  8001de:	4501                	li	a0,0
  ...
  8001f0:	5a458593          	addi	a1,a1,1444 # 800790 <main+0x106>
  8001f4:	4505                	li	a0,1
...
0000000000800242 <printnum>:
  ...
  80028a:	75278793          	addi	a5,a5,1874 # 8009d8 <error_string+0xc8>
...
00000000008002b8 <vprintfmt>:
  ...
  8002e4:	4d4a8a93          	addi	s5,s5,1236 # 8007b4 <main+0x12a>
  ...
  8003d0:	54468693          	addi	a3,a3,1348 # 800910 <error_string>
  8003d4:	97b6                	add	a5,a5,a3
  8003d6:	639c                	ld	a5,0(a5)
  8003d8:	1a078763          	beqz	a5,800586 <vprintfmt+0x2ce>
  8003dc:	873e                	mv	a4,a5
  8003de:	00001697          	auipc	a3,0x1
  8003e2:	80268693          	addi	a3,a3,-2046 # 800be0 <error_string+0x2d0>
  ...
  80058a:	64a68693          	addi	a3,a3,1610 # 800bd0 <error_string+0x2c0>
  ...
  80059e:	62e70713          	addi	a4,a4,1582 # 800bc8 <error_string+0x2b8>
  8005a2:	00000417          	auipc	s0,0x0
  8005a6:	62740413          	addi	s0,s0,1575 # 800bc9 <error_string+0x2b9>
  ...
  800638:	59540413          	addi	s0,s0,1429 # 800bc9 <error_string+0x2b9>
...
000000000080068a <main>:
  80068a:	1101                	addi	sp,sp,-32
  80068c:	ec06                	sd	ra,24(sp)
  80068e:	e822                	sd	s0,16(sp)
  800690:	e426                	sd	s1,8(sp)
  800692:	e04a                	sd	s2,0(sp)
  800694:	aefff0ef          	jal	ra,800182 <getpid>
  800698:	85aa                	mv	a1,a0
  80069a:	00000517          	auipc	a0,0x0
  80069e:	54e50513          	addi	a0,a0,1358 # 800be8 <error_string+0x2d8>
  8006a2:	a17ff0ef          	jal	ra,8000b8 <cprintf>
  8006a6:	4401                	li	s0,0
  8006a8:	00000917          	auipc	s2,0x0
  8006ac:	56090913          	addi	s2,s2,1376 # 800c08 <error_string+0x2f8>
  8006b0:	4495                	li	s1,5
  8006b2:	acdff0ef          	jal	ra,80017e <yield>
  8006b6:	acdff0ef          	jal	ra,800182 <getpid>
  8006ba:	8622                	mv	a2,s0
  8006bc:	85aa                	mv	a1,a0
  8006be:	2405                	addiw	s0,s0,1
  8006c0:	854a                	mv	a0,s2
  8006c2:	9f7ff0ef          	jal	ra,8000b8 <cprintf>
  8006c6:	fe9416e3          	bne	s0,s1,8006b2 <main+0x28>
  8006ca:	ab9ff0ef          	jal	ra,800182 <getpid>
  8006ce:	85aa                	mv	a1,a0
  8006d0:	00000517          	auipc	a0,0x0
  8006d4:	56050513          	addi	a0,a0,1376 # 800c30 <error_string+0x320>
  8006d8:	9e1ff0ef          	jal	ra,8000b8 <cprintf>
  8006dc:	00000517          	auipc	a0,0x0
  8006e0:	57450513          	addi	a0,a0,1396 # 800c50 <error_string+0x340>
  8006e4:	9d5ff0ef          	jal	ra,8000b8 <cprintf>
  8006e8:	60e2                	ld	ra,24(sp)
  8006ea:	6442                	ld	s0,16(sp)
  8006ec:	64a2                	ld	s1,8(sp)
  8006ee:	6902                	ld	s2,0(sp)
  8006f0:	4501                	li	a0,0
